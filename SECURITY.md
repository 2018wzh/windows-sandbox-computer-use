...
- enable generic RDP access, command execution, or certificate validation bypasses.
...
- The adapter does not expose passwords, generic RDP targets, certificate bypasses, clipboard redirection, whole-volume redirection, or remote command execution.
